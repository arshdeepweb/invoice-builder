...
const ClientPDFDownload = dynamic(() => import("../../components/pdf/PDFDownloadLink"), {
  ssr: false,
});
...
export default function InvoiceCreator() {
  ...
  const calculateTotals = (
    ...
    const taxAmount =
      (calculatedSubtotal - currentDiscountValue) * (currentTaxPercent / 100);
    const calculatedTotal =
      calculatedSubtotal - currentDiscountValue + taxAmount + currentShipping;
  ...
  const handleCreateInvoice = () => {
    ...
    alert(
      "Invoice data logged to console. Implement PDF generation or API call."
    );
  };
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 space-y-8">
                  ...
                  <div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 space-y-3 bg-gray-50/50">
                      <input
                        ...
                        className="w-full bg-transparent border-0 border-b border-gray-300 pb-1 text-sm focus:outline-none focus:border-blue-500 placeholder-gray-400"
                      />
                      <textarea
                        placeholder="Address"
                        ...
                        className="w-full bg-transparent border-0 border-b border-gray-300 pb-1 text-sm focus:outline-none focus:border-blue-500 placeholder-gray-400 h-16 resize-none"
                      />
                      <input
                        type="text"
                        placeholder="Phone"
                      ...
                      <input
                        ...
                        className="w-full bg-transparent border-0 text-sm focus:outline-none placeholder-gray-400"
                      />
                    </div>
                  </div>
                  {/* To Details */}
                  <div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 space-y-3 bg-gray-50/50">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setToDetails({ ...toDetails, phone: e.target.value })
                        }
                        className="w-full bg-transparent border-0 border-b border-gray-300 pb-1 text-sm focus:outline-none focus:border-blue-500 placeholder-gray-400"
                      />
                      <input
                      ...
                      <input
                        type="text"
                        placeholder="Client TAX ID / VAT Number"
                        value={toDetails.taxId}
                        onChange={(e) =>
                          setToDetails({ ...toDetails, taxId: e.target.value })
                        }
                        className="w-full bg-transparent border-0 text-sm focus:outline-none placeholder-gray-400"
                      />
                    </div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[600px]">
                    <thead className="bg-gray-100">
                      <tr>
                        <th className="py-2 px-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-2/5">
                          Item Description
                        </th>
                        <th className="py-2 px-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-[80px]">
                          Qty
                        </th>
                        <th className="py-2 px-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-[100px]">
                          Rate
                        </th>
                        <th className="py-2 px-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-[100px]">
                          Discount (%)
                        </th>
                        <th className="py-2 px-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider w-[120px]">
                          Amount
                        </th>
                  ...
                  <div className="w-full md:w-1/2 lg:w-2/5">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <label
                          key={method}
                          className="flex items-center p-3 border rounded-lg hover:border-blue-300 cursor-pointer transition duration-150 has-[:checked]:bg-blue-50 has-[:checked]:border-blue-400"
                        >
                          <input
                            type="radio"
                            name="paymentMethod"
                  ...
                  <div className="w-full md:w-1/2 lg:w-3/5 bg-gray-50 rounded-lg p-6">
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-sm font-medium text-gray-800">
                          {formatCurrency(
                            (subtotal - discountValue) * (tax / 100)
                          )}
                        </span>
                      </div>
                  ...
                  <div className="border border-gray-200 rounded-lg p-5 bg-gray-50/50">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3">
                      ...
                      <input
                        ...
                        className="w-full bg-transparent border-0 border-b border-gray-300 pb-1 text-sm focus:outline-none focus:border-blue-500 placeholder-gray-400 sm:col-span-2"
                      />
                    </div>
                  </div>
                </section>
              ...
              <section className="pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-end items-center space-y-3 sm:space-y-0 sm:space-x-4">
                <button
                  ...
                  onClick={() => {
                    /* Add cancel logic - e.g., redirect or clear form */ alert(
                      "Cancel action"
                    );
                  }}
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  ...
                  <p>
                    ...
                    {dueDate
                      ? format(new Date(dueDate + "T00:00:00"), "PP")
                      : "N/A"}{" "}
                  </p>{" "}
                  {/* Format date nicely */}
                ...
                <p className="text-xs text-gray-400 mt-5 italic">
                  Ensure all details are correct before downloading. The PDF
                  will reflect the current form data.
                </p>
              </div>
